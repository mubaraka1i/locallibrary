...
def seed_books(apps, schema_editor):
    ...
    Language.objects.get_or_create(
        name__iexact="Français", defaults={"name": "Français"}
    )
    ...
    Language.objects.get_or_create(
        name__iexact="Italiano", defaults={"name": "Italiano"}
    )
    Language.objects.get_or_create(
        name__iexact="Português", defaults={"name": "Português"}
    )
    Language.objects.get_or_create(
        name__iexact="Nederlands", defaults={"name": "Nederlands"}
    )
...
class Migration(migrations.Migration):
    ...
    # FIXME: remove assert False and replace "000X_YOUR_MOST_RECENT_MIGRATION_NAME"
